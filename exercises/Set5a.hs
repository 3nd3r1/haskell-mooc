...
rgb Green = [0,1,0]
rgb Blue = [0,0,1]
rgb (Mix c1 c2) = [(head rgb1 + head rgb2)/2, (rgb1 !! 1 +rgb2 !! 1)/2, (rgb1 !! 2 + rgb2 !! 2)/2]
                  where rgb1 = rgb c1
                        rgb2 = rgb c2
rgb (Invert c) = [1 - head rgb1, 1 - rgb1 !! 1, 1 - rgb1 !! 2]
                 where rgb1 = rgb c
...
toNat n
    | n<0 = Nothing
    | otherwise = maybe (Just Zero) (Just . PlusOne) (toNat (n-1))
...
fromBin b = fromBin' b 0
            where fromBin' (I b) n = 2^n + fromBin' b (n+1)
